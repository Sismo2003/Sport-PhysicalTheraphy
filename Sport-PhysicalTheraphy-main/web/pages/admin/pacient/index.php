...
<script src="resources/js/pacient.js"></script>
<script type="module" src="resources/js/medic.js"></script>

<div class="grid m-5 grid-cols-2 gap-5">
    ...
    <div class="col-span-2 flex w-full space-x-4">
        <div class="bg-gray-800 w-1/2 h-[10rem] rounder-lg">
...
<div id="modal" class="fixed  inset-0 bg-slate-100 bg-opacity-75 z-50 hidden">
    <div class="flex items-center justify-center h-screen">
        ...
        <div class="bg-white p-2 rounded-xl shadow-xl shadow-cyan-500/50 w-[590px] h-[450px] mx-3">
            <!---Title -->
            <h2 id="modalTitle" class="text-2xl text-center font-bold my-2">CREAR NUEVO PACIENTE</h2>
            <div class="w-full" >
                <!---Nav -->
